        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        var roleResult = UserManager.AddToRole(currentUser.Id, "tutor");
                    }
                    EmailSender emailSender = new EmailSender();
                    emailSender.Send(model.Email, "Data Training - Register Successfully", "Dear, you have registered successfully!", null, null);
